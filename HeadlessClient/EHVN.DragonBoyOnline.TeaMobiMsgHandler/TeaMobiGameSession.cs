...
{
    public class TeaMobiGameSession : GameSession<TeaMobiMsgSender, TeaMobiMsgReceiver>
    {
        internal static Dictionary<int, int> MapTileIDs = new Dictionary<int, int>()
        {
            ...
            { 181, 13 },
            { 182, 34 }, { 183, 34 },
            { 184, 35 }, { 185, 35 }, { 186, 36 },

            //{ 169, -1 },
            //{ 78, -1 },
        };

        public TeaMobiGameSession() : base(new TeaMobiMsgSender(), new TeaMobiMsgReceiver()) 
        {
            Data.MapTileIDs = MapTileIDs;
        }
    }
}
